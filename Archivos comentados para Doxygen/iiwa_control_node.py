...
class iiwa_surgery_node_class:
    ...
    Es importante destacar que los parámetros de configuración utilizados en esta clase se obtienen del archivo iiwa_surgery_params.yaml. A continuación, se muestra cómo se enlazan estos parámetros con las variables de la clase:
    ...
    def cartesian_pose_callback(self, msg):
        """!
        Callback para recibir estados de posición cartesiana y posteriormente publicarlos en el topic iiwa_surgery/output/ef_pose y tras trasnformación en iiwa_surgery/output/tcp_pose.
