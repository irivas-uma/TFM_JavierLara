...
class IiwaSurgeryNode:
    ...
    def joint_command_callback(self, msg):
        """
        Callback para recibir comandos de posición conjunta.
        Args:
             msg: Mensaje de posición conjunta (JointPosition).
        """
        # Mover el robot a una posición conjunta específica
        joint_config = JointPosition()
        joint_config = msg
        # Enviar mensaje de posición conjunta al método
        self.iiwa.move_joint(joint_config)       
        
    def pose_command_callback(self, msg):
        """
        Callback para recibir comandos de posición cartesiana.
        Args:
             msg: Mensaje de posición cartesiana (PoseStamped).
        """
    ...
    def joint_state_callback(self, msg):
        """
        Callback para recibir estados de posición conjunta.
        Args:
             msg: Mensaje de estado de posición conjunta (JointState).
        """
        ...
        # Publicar el estado de posición conjunta 
    ...
    def joint_position_callback(self, msg):
        ...
        Callback para recibir estados de posición conjunta.
        Args:
             msg: Mensaje de estado de posición conjunta (JointPosition).
        """
        # Publicar el estado de posición conjunta recibido
        self.joint_pub.publish(msg)

    def cartesian_pose_callback(self, msg):
        """
        Callback para recibir estados de posición cartesiana.
        Args:
             msg: Mensaje de estado de posición cartesiana (PoseStamped).
        """
