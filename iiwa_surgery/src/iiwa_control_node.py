...
class IiwaSurgeryNode:
    ...
    def joint_command_callback(self, msg):
        """
        @brief Callback para recibir comandos de posición conjunta.
        @param msg: Mensaje de posición conjunta (JointPosition).
        """
    ...
    def pose_command_callback(self, msg):
        """
        @brief Callback para recibir comandos de posición cartesiana.
    ...
    def joint_state_callback(self, msg):
        """
        @brief Callback para recibir estados de posición conjunta.
        @param msg: Mensaje de estado de posición conjunta (JointState).
        """
    ...
    def joint_position_callback(self, msg):
        """
        @brief Callback para recibir estados de posición conjunta.
        @param msg: Mensaje de estado de posición conjunta (JointPosition).
        """
    ...
    def cartesian_pose_callback(self, msg):
        """
        @brief Callback para recibir estados de posición cartesiana.
