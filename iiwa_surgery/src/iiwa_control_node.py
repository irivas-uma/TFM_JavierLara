...
class IiwaSurgeryNode:
    ...
    def cartesian_pose_callback(self, msg):
        ...
        #TENGO QUE MODIFICAR ESTO PARA QUE TENIENDO LA POSICION Y ORIENTACION DEL EF ME DE LA DEL TCP. COMO LA HERRAMIENTA ES UN PALO PUES LA ORIENTACION SERA LA MISMA QUE LA DEL EF
