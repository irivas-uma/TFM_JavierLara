...
class iiwa_surgery:
    """
    @brief Clase para controlar un robot quirúrgico Kuka en un entorno de ROS.
    ...
    def __init__(self, simulation_mode=True):
        """
        @brief Inicializa una instancia de la clase iiwa_surgery.
        @param simulation_mode (bool, opcional): Indica si se está ejecutando en modo simulación. El valor predeterminado es True.
        """
    ...
    def set_tool_data(self, tool_length, tool_orientation):
        """
        @brief Configura los datos de la herramienta.
    ...
    def set_fulcrum_fi(self, fulcrum_fi):
        """
        @brief Configura el punto de fulcro.
    ...
    def set_robot_ip(self, robot_ip):
        """
        @brief Configura la dirección IP del robot.
    ...
    def set_work_mode(self, work_mode):
        """
        @brief Configura el modo de trabajo del robot.
    ...
    def move_joint(self, joint_config):
        """
        @brief Mueve el robot en el espacio de articulación.
    ...
    def move_cartesian(self, pose):
        """
        @brief Mueve el robot en el espacio cartesiano.
        @param pose (geometry_msgs.msg.PoseStamped): Posición y orientación deseada del efector final en espacio cartesiano.
        """
    ...
    def move_cartesian_fulcrum(self, pose, increment_vector, j):
        """
        @brief Mueve el robot en el espacio cartesiano alrededor de un punto de fulcro.
        @param pose (geometry_msgs.msg.PoseStamped): Posición y orientación deseada del efector final en espacio cartesiano.
