...
class iiwa_surgery:
    ...
    def move_cartesian_fulcrum(self, pose):
        ...
        while not rospy.is_shutdown():
            ...
            # Realizar los cálculos adicionales necesarios para el movimiento de la pinza (Ph1, Ph2, Ph3)
            Ph1 = 0.0  # Reemplaza este valor con el incremento para la posición x de la herramienta
            Ph2 = 0.0  # Reemplaza este valor con el incremento para la posición y de la herramienta
            Ph3 = 0.0  # Reemplaza este valor con el incremento para la posición z de la herramienta
            ...
            if(j == 0):
                Pf = P + self.fulcrum_point*Dt*z #El punto de fulcro lo calculamos al principio y no cambia
                print(Pf)
