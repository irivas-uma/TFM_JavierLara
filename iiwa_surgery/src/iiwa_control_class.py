...
class iiwa_surgery:
    ...
    def move_cartesian_fulcrum(self, pose, increment_vector, j):
        ...
        Ptcp = [pose.pose.position.x, pose.pose.position.y, pose.pose.position.z]
        ...
        if(j == 0):
            ...
            Pf = Pef + self.fulcrum_fi*direction_transformed #El punto de fulcro lo calculamos al principio y no cambia
        ...
        #Nueva posicion de la punta con el incremento
